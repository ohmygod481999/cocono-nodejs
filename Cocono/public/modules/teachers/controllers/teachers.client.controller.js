var teacherControllers = angular.module('teacherControllers',[])

teacherControllers.controller('TeacherController',function TeacherController($scope, $http){
    $scope.title = 'Xin chao';

    $scope.courses = [];
    $scope.getCourses = function () {
        $http.get('/courses/api').then(function (result) {
    ...
    $scope.init = function() {
        ...
        jQuery.each(includes, function(){
            var file = 'shared_views/' + $(this).data('include') + '.html';
            $(this).load(file);
        });
